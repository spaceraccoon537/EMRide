...
public class order_mechanic extends AppCompatActivity {
    ...
    private String latitude, longitude,issue,problem;
    private  int base_cost,act_cost;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_order_mechanic);
        ...
        String[] items={"Bike / 2 Wheeler","Auto / 3 Wheeler","Car / 4 Wheeler","Bus / Truck"};
        ArrayAdapter<String> itemadapter=new ArrayAdapter<>(order_mechanic.this,R.layout.list_item,items);
        ...
        dropdown_menu.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                String chooice=items[i];
                if(i==0){
                    act_cost=base_cost;
                }
                else if (i==1){
                    act_cost=base_cost*2;
                }
                else if (i==2){
                    act_cost=base_cost*3;
                }
                else{
                    act_cost=base_cost*4;
                }
                btn_submit.setEnabled(true);
                ll_orderDetails.setVisibility(View.VISIBLE);

                int tot_pr=Integer.parseInt(String.valueOf(act_cost))+50;
                service_charge.setText(String.valueOf((act_cost)));
        ...
        btn_submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(TextUtils.isEmpty(reg_no)){
                    Toast.makeText(order_mechanic.this, "Enter a valid Registration Number", Toast.LENGTH_SHORT).show();
                    return;
                }
                if(service_charge.getText().toString().trim().isEmpty()){
                    Toast.makeText(order_mechanic.this, "Select a valid order", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                String petrolPrice=service_charge.getText().toString().trim().replace("$","");
                String regNo=textstyle.getText().toString().trim().replace("$","");
                addToCart(title,petrolPrice,delPrice,finalPrice,regNo);

                new AlertDialog.Builder(order_mechanic.this).setIcon(android.R.drawable.ic_dialog_alert)
    ...
    private void addToCart(String title, String petrolPrice, String delPrice, String finalPrice,String regNo) {
        ...
        boolean b=easyDB.addData("ORDER_ID",orderID)
                ...
                .addData("ORDER_petrolPrice",petrolPrice)
    ...
    private void makeOrder(View view) {
        ...
        AlertDialog.Builder builder=new AlertDialog.Builder(order_mechanic.this);
        builder.setView(view);

        EasyDB easyDB=EasyDB.init(order_mechanic.this,"ORDERS_DB")
                .addColumn(new Column("ORDER_ID",new String[]{"text","unique"}))
        ...
        while(res.moveToNext()) {
            ...
            if(orderItemList.size()==0){
                Toast.makeText(order_mechanic.this, "No items in Cart", Toast.LENGTH_SHORT).show();
                return;
            }
            submitOrder();
    ...
    private void submitOrder() {
        ...
        hashMap.put("orderTitle",problem);
        ...
        reference.child(timeStamp).setValue(hashMap)
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        ...
                        Toast.makeText(order_mechanic.this, "Order Placed....", Toast.LENGTH_SHORT).show();

                        startActivity(new Intent(order_mechanic.this, OrdersListActivity.class));
...
//                        startActivity(intent);
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        progressDialog.dismiss();
                        Toast.makeText(order_mechanic.this, ""+e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
